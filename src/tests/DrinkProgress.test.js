...
const IN_PROGRESS_DRINK_ROUTE = '/bebidas/178319/in-progress';
const IN_PROGRESS_DRINK_NAME = 'Aquamarine';
const IN_PROGRESS_INGREDIENT_LENGTH = 3;
...
describe('Testa tela de receita em progresso', () => {
  ...
  it('deve possuir 3 checkboxes', async () => {
    renderWithRouterAndStore(<App />, { route: IN_PROGRESS_DRINK_ROUTE });
  ...
  it('deve ser possível marcar as checkboxes e finalizar a receita', async () => {
    ...
    expect(finishedRecipeName).toHaveTextContent(IN_PROGRESS_DRINK_NAME);
  });
});
